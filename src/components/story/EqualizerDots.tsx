 ...
 * the top corner of a handful of sections (the CTA band and the closing
 * archive strip on Story; also used on About's Schenirer bio via its own
 * copy of this component). Reshuffles which 3 of 6 dots are "lit" every
 * 2.5s, and on hover/focus. `aria-hidden` — it carries no content.
 *
